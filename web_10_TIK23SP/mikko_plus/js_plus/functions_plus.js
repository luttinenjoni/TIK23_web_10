...
window.onload = function(){
    let scoreFromBrowser = localStorage.getItem("highscore1");
    if (scoreFromBrowser != undefined) highScore = scoreFromBrowser; 
    document.getElementById("highscore1").innerHTML = "Paras tuloksesi: " + highScore;
...
function checkAnswer(buttonIndex){
    ...
    localStorage.setItem("highscore1",highScore); //highscoren tallennus!!
    document.getElementById("highscore1").innerHTML = "Paras tuloksesi: " + highScore;
